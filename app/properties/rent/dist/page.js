...
var RentProperties = function (props) {
    var rent_properties = maindata_1.properties.filter(function (property) { return property.listing_type.toLowerCase() === "rent"; });
    return (react_1["default"].createElement("div", { className: "flex flex-col gap-8" },
        react_1["default"].createElement("div", { className: "px-2 above-480:px-4 p-16 bg-black lg:!py-20 text-white flex flex-col gap-4" },
            ...
            react_1["default"].createElement("div", { className: "flex gap-4 justify-center items-center" },
                ...
                react_1["default"].createElement(link_1["default"], { href: "/properties/rent", className: "p-2 px-4 transition-all bg-white hover:bg-[#A1A1A1] duration-300 text-black hover:text-black flex justify-center items-center h-10 border cursor-pointer border-white" }, "Rent"),
                react_1["default"].createElement(link_1["default"], { href: "/properties/sell", className: "p-2 px-4 transition-all bg-black hover:bg-white duration-300 text-white hover:text-black flex justify-center items-center h-10 border cursor-pointer border-white" }, "Sell"))),
        react_1["default"].createElement("div", { className: "p-4 sm:p-6 pb-16" },
            react_1["default"].createElement("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-8" }, rent_properties.map(function (property) { return (react_1["default"].createElement("div", { className: "flex flex-col gap-4 cursor-pointer", key: property.id },
...
exports["default"] = RentProperties;
